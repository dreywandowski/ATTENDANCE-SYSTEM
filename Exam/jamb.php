...
<form id="begin" method="POST" action="validate_details.php">
	...
	<label for="Surname"> Username:</label>
		...
		<input type="text" id="name" name="username"  value="<?php echo $username ?>" minlength="8" required>
		<br><br>

		<label for =  "JAMB no">Password:</label>

			<input type="password" id="number" value="<?php echo $password?>" name="password" minlength="8" required><br>
