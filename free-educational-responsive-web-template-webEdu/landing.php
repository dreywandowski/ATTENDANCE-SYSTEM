...
<body>
    ...
    <div class="main">
       <!-- <a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.php"><img class="d-inline-block me-3" src="assets/img/icons/logo.png" alt="" /></a>-->
                    ...
                    <div class="signup-form register" >
                        ...
                        <form method="POST" class="register-form" action="config/Register.php"  enctype="multipart/form-data" method="POST"  name="reg" >
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name"  required autocomplete="name" autofocus placeholder="First Name"/>
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="last_name" required autocomplete="name" autofocus placeholder="Last Name"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <span id="usercheck" ></span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password1" name="re_pass" id="pass2" placeholder="Repeat your password"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" hidden>
                             <input type="text" value="assets/images/uploads/male-profile-picture.jpg" readonly name="file_path" >
                         </div>
                    <p></p>
        ...
        <section class="sign-in" id="login">
            <div class="container">
                <div class="signin-content">
                    ...
                    <button class="form-button"  type="submit" class="form" name="sub"> Login</button>
